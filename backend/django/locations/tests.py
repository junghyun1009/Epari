...
class LocationsTest(APITestCase):
  def setUp(self):
    ...
    self.collect1 = Collect.objects.create(collectId=1, plantId=self.plant1, collectPictureUrl="", collectDate=pd.Timestamp('2022-01-01T21:19:34'), collectContent="", userId=self.user, collectPlace="서울시 동작구")
  # 관광지 추천 성공
